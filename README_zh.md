...
如果你是第一次使用独轮车，按下面流程操作即可：

1. 打开 `DLCart.exe`
2. 在浏览器里复制视频页面链接
3. 把链接粘贴到 **Video URL** 输入框
4. 如果没有特殊需求，画质保持在 **Best Quality**
5. 点击 **Download**
6. 等待任务状态变成 `COMPLETED`
7. 右键点击已完成的记录，选择 **Open File** 或 **Open Folder**

小提示：

- 如果网站需要登录，可在 **Advanced** 或 **Settings** 中设置 **Cookie Browser**
- 如果你的网络需要代理，可在 **Proxy URL** 中填写代理地址
- 如果下载失败，可以右键任务后选择 **Retry**
- 如果你只想下载音频，下载前选择 **Audio Only**

### 给新手看的操作指南

如果你不想折腾高级设置，最简单的用法就是：

1. 在浏览器里打开视频页面，并复制完整链接
2. 回到独轮车，把链接粘贴到顶部输入框
3. 画质保持在 **Best Quality**
4. 点击 **Download**
5. 观察下方任务列表里的状态变化

你会看到这些状态：

- `QUEUED`：任务正在排队，等待空闲下载槽位
- `DOWNLOADING`：正在下载
- `PROCESSING`：正在做收尾处理，比如合并或整理文件
- `COMPLETED`：已经下载完成，可以打开
- `FAILED`：下载失败，可以右键后选择 **Retry**

什么时候需要用 Advanced 或 Settings：

- 如果你只想要音频，就选 **Audio Only**
- 如果你的网络确实依赖代理，再填写 **Proxy URL**
- 如果网站要求登录、年龄验证或账号验证，再设置 **Cookie Browser**
- 对普通公开视频来说，高级设置大多数情况下都可以留空

三个最常见的使用场景：

1. 下载普通公开视频：
   粘贴链接，保持 **Best Quality**，点击 **Download**
2. 只下载音频：
   粘贴链接，选择 **Audio Only**，点击 **Download**
3. 下载需要登录的视频：
   粘贴链接，打开 **Advanced**，在 **Cookie Browser** 中选择你的浏览器，然后再下载
